...
\begin{fichacatalografica}
	...
	\begin{center}
		\fbox{%
			\begin{minipage}[c][7.5cm][c]{12cm}
				\centering
				\textbf{Ficha catalográfica}\\[1\baselineskip]
				Substitua este quadro pela ficha catalográfica gerada no sistema da
				Biblioteca Universitária da UFSC.\\[0.5\baselineskip]
